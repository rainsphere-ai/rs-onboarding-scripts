...
# or via wget:
#   sh -c "$(wget -qO- https://raw.github.com/rainsphere-ai/rs-onboarding-scripts/main/install-nostromo.sh)"
# or via fetch:
#   sh -c "$(fetch -o - https://raw.github.com/rainsphere-ai/rs-onboarding-scripts/main/install-nostromo.sh)"
#
# As an alternative, you can first download the install script and run it afterwards:
#   wget https://raw.github.com/rainsphere-ai/rs-onboarding-scripts/main/install-nostromo.sh
#   sh install.sh
#
# Other options:
...
# or:
#   sh -c "$(curl -fsSL https://raw.github.com/rainsphere-ai/rs-onboarding-scripts/main/install-nostromo.sh)" "" --unattended
#
set -e
...
print_success() {
  fmt_info "Hooray! nostromo has been installed."
  printf '\n'
  printf '\n'
...
main() {
  ...
  if [ $RUNZSH = no ]; then
    echo "${FMT_YELLOW}Run nostromo to try it out.${FMT_RESET}"
    exit
  fi
